...
public class BufferMgr {
	 ...
	 * first.
	 * 
	 * Added a call to LogMgr to handle pinning of log block
	 * 
	 * @param numbuffers
	...
	public BufferMgr(int numbuffers) {
		...
		SimpleDB.logMgr().setPage(bufferMgr.pin(SimpleDB.logMgr().getCurrentblk()));
	}
	 ...
	 * @author abhardw3, achauha3, kdpandya, nkapadi, pjmandle
	 */
	public BufferMgr(int numbuffers, int lru_k_value) {
		bufferMgr = new BasicBufferMgr(numbuffers, lru_k_value);
	}

	/**
	 * return the Buffer associated with the block from the pool
	 * @param blk
	 * @param time
	 * @return
	 * @author abhardw3, achauha3, kdpandya, nkapadi, pjmandle
	...
	/**
	 * return true if time exceed the waiting period
	 * 
	 * @param starttime
	 * @return
	 * @author abhardw3, achauha3, kdpandya, nkapadi, pjmandle
	...
	/**
	 * Callback to BasicBufferManager of same name
	 * 
	 * @author abhardw3, achauha3, kdpandya, nkapadi, pjmandle
	 */
	public void printBufferPoolBlocks() {
		bufferMgr.printBufferPoolBlocks();
	}

	/**
	 * Callback to BasicBufferMgr function of same name
	 * 
	 * @author abhardw3, achauha3, kdpandya, nkapadi, pjmandle
	 */
	public void printLogBuffer() {
		bufferMgr.printLogBuffer();
	}
}
